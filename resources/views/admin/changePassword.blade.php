...
<div class="col-md-6 offset-md-3" style="padding-top: 3em;">
  <div class="card card-default">
    <div class="card-heading"><h3 class="text-center">Change Password</h3>
      <div class="card-body">
...
<form method="POST" action="{{ route('admin.submit.changePassword') }}" class="form-horizontal" role="form">
